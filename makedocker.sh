...
docker push marcinu2l/microservices:rental-notification-service
docker push marcinu2l/microservices:rental-ride-service
docker push marcinu2l/microservices:rental-statistics-service
